...
namespace GraphicsEngineSpace
{
	...
	void RenderTargetDepth::CreateRenderTarget(ID3D11Device* _device, ID3D11DeviceContext* _immediateDC, IDXGISwapChain* _swapChain, int _clientWidth, int _clientHeight, UINT _4xMSAAQuality)
	{
